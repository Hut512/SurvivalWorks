package de.survivalworks.core.engine.vk;

import de.survivalworks.core.engine.vk.rendering.*;
import de.survivalworks.core.engine.vk.rendering.Queue;
import de.survivalworks.core.engine.vk.scene.Entity;
import de.survivalworks.core.engine.vk.scene.Scene;
import de.survivalworks.core.engine.vk.shaders.ShaderProgram;
import de.survivalworks.core.engine.vk.vertex.Model;
import de.survivalworks.core.engine.vk.vertex.Texture;
import de.survivalworks.core.engine.vk.vertex.VertexBufferStruct;
import de.survivalworks.core.engine.vk.pipeline.Pipeline;
import de.survivalworks.core.engine.vk.pipeline.PipelineCache;
...
public class ForwardRenderActivity {
    ...
    public ForwardRenderActivity(SwapChain swapChain, CommandPool commandPool, PipelineCache pipelineCache, Scene scene) {
        ...
        //ShaderCompiler.reCompileShader(VERTEX_SHADER, Shaderc.shaderc_glsl_vertex_shader);
        //ShaderCompiler.reCompileShader(FRAGMENT_SHADER,Shaderc.shaderc_glsl_fragment_shader);
    ...
    private void createDescriptorSets(int numImages) {
        ...
        materialBuffer = new Buffer(device, (long) materialSize * 500, VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT);
