package de.survivalworkers.core.client.engine.graphics.scene;
...
public class Camera {
    ...
    private void recalculate() {
        viewMatrix.identity().rotateX(rotation.x).rotateY(rotation.y).translation(-position.x,-position.y,-position.z);
    }
